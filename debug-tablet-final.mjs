...
await page.screenshot({ path: '/tmp/se-community-tablet-correct.png' })
...
await page.waitForTimeout(500)
await page.screenshot({ path: '/tmp/se-events-tablet-correct.png' })
